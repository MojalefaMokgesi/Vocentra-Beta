        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PortfolioWebsite = table.Column<string>(type: "TEXT", nullable: true),
                    ResumeLink = table.Column<string>(type: "TEXT", nullable: false),
                    HighestQualification = table.Column<string>(type: "TEXT", nullable: true),
                    CurrentCTC = table.Column<string>(type: "TEXT", nullable: true),
                    ExpectedCTC = table.Column<string>(type: "TEXT", nullable: true),
                    CertificateUrls = table.Column<string>(type: "TEXT", nullable: true),
